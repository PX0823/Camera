...
public class SettingDataBase {
 ...
 MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_SLOW_MOTION_VIDEO_QUALITY]    = new int[]{
        ...
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_DNG]                   = new int[]{
                STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_R0,
                STATE_R0, STATE_R0, STATE_E0, STATE_R0};
		MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_DUALCAM_MODE]          = new int[]{
                STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_R0,
                STATE_R0, STATE_R0, STATE_E0, STATE_R0};
    }
    ...
    static {
        ...
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_DNG]
                = new String[]{"off", "on"};
		RESET_STATE_VALUE[SettingConstants.ROW_SETTING_DUALCAM_MODE]
                = new String[]{"off", "on"};
    }
    ...
    static {
		...
		DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_DUALCAM_MODE]
                = R.string.pref_dual_cam_mode_default;
    }
