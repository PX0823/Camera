...
public interface IMultiCameraDeviceAdapter {
    ...
    //Define service event type.
    public static final int REMOTE_CAMERA_ORIENTATION_CHANGE = 0;
    ...
    public interface IDevicesStatusListener {
        ...
        /**
         * When remote camera service has event status change, cross mount framework will notify
         * new status.
         * @param event Camera service event type.
    ...
    /**
     * Query the remote devices,may be disconnect when camera is paused,
     * Such as pause camera and disconnect remote camera from cross mount setting.
     * so when camera resume again,need check the remote camera
     * @return The remote camera device connect status.
     */
