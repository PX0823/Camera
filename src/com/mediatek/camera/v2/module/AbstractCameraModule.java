...
import com.mediatek.camera.v2.mode.multicamera.MultiCameraMode;
...
public abstract class AbstractCameraModule implements
    ...
    protected void createCurrentMode(int modeIndex) {
        ...
        case ModeChangeListener.MODE_MULTI_CAMERA_SINK:
            mCurrentMode = new MultiCameraMode(mAppController, this);
            break;
    ...
    protected void doModeChange(int oldModeIndex, int newModeIndex) {
        ...
        case ModeChangeListener.MODE_PIP:
            ...
            break;
        case ModeChangeListener.MODE_MULTI_CAMERA_SINK:
            changedModes.put(SettingKeys.KEY_MULTI_CAMERA_SINK, "off");
            break;
        default:
            break;
        }
        ...
        case ModeChangeListener.MODE_PIP:
            ...
            break;
        case ModeChangeListener.MODE_MULTI_CAMERA_SINK:
            changedModes.put(SettingKeys.KEY_MULTI_CAMERA_SINK, "on");
            break;
        default:
            break;
        }
