...
public class SettingKeys {
    ...
    public static final int SETTING_COUNT = 57;
    // setting key
    ...
    public static final String KEY_MULTI_CAMERA_SINK         = "multi_camera_key";
    public static final String KEY_MULTI_CAMERA_MULTI_PREVIEW = "multi_camera_multi_preview";
    ...
    public static final int ROW_SETTING_FAST_AF                   = 50; //common
    public static final int ROW_SETTING_DISTANCE                  = 51; //common
    public static final int ROW_SETTING_DUAL_CAMERA_MODE          = 52; //common
    public static final int ROW_SETTING_OBJECT_TRACKING           = 53;
    public static final int ROW_SETTING_DNG                       = 54;
    public static final int ROW_SETTING_SINK_CAMERA               = 55; //common
    public static final int ROW_SETTING_MULTI_PREVIEW             = 56;
    ...
    static {
        ...
        SETTING_TYPE[ROW_SETTING_SINK_CAMERA]               = DO_NOT_APPLY_TO_NATIVE;
        SETTING_TYPE[ROW_SETTING_MULTI_PREVIEW]             = DO_NOT_APPLY_TO_NATIVE;
    ...
    static {
        ...
        KEYS_FOR_SETTING[ROW_SETTING_MULTI_PREVIEW]         = KEY_MULTI_CAMERA_MULTI_PREVIEW;
    };
