...
public class MultiCameraGestureImpl implements ISinkGestureCtrl {
    ...
    private static final Tag TAG = new Tag(
            MultiCameraGestureImpl.class.getSimpleName());
    ...
    private final AnimationRect mEmptyRenderRect;
    ...
    public MultiCameraGestureImpl(Activity activity) {
        LogHelper.i(TAG, "[MultiCameraGestureImpl]");
        Assert.assertNotNull(activity);
        mRemotePreviewGraphicRect = new AnimationRect();
        mLocalPreviewGrapichRect = new AnimationRect();
        mEmptyRenderRect = new AnimationRect();
        mEmptyRenderRect.setRendererSize(0, 0);
    }

    @Override
    public void updatePreviewCamera(List<String> cameraID) {
        LogHelper.i(TAG, "[updatePreviewRect] cameraID = " + cameraID);
    ...
    public void setPreviewSize(Size previewSize) {
        ...
        LogHelper.i(TAG, "[setPreviewSize]+ : " + mPreviewWidth + " x " + mPreviewHeight);
    }
    ...
    private void toSinglePreview(boolean isLocal) {
        ...
        LogHelper.i(TAG, "[toSinglePreview] islocal = " + isLocal
                + ",width = " + width + ",height = "
                + height);
