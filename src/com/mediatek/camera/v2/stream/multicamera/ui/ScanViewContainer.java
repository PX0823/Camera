 ...
 */
public class ScanViewContainer extends RelativeLayout {

    private static final Tag TAG = new Tag(
            ScanViewContainer.class.getSimpleName());
    /**
     ...
     */
    public ScanViewContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        LogHelper.i(TAG, "onMeasure previewWidth = " + previewWidth
