...
public class OperateView implements IMultiCameraView {
    ...
    private static final Tag TAG = new Tag(
            OperateView.class.getSimpleName());
    ...
    @Override
    public void close() {
        ((ViewGroup) mParentView.getParent()).removeView(mDialogContainer);
    }
    ...
    public void updatePreviewCamera(List<String> cameraId,
        ...
        LogHelper.i(TAG,
                "[updatePreviewCamera] list size = "
                        + mPreviewingCameraId.size() + ",RemoteOpened = "
                        + mRemoteCameraOpened);
    ...
    public void startCountdown(int sec) {
        LogHelper.i(TAG, "startCountdown sec " + sec);
    ...
    private void disableOperateView() {
    ...
    private void enableOperateView() {
