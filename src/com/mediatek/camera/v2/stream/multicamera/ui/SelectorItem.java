...
public class SelectorItem extends RelativeLayout {
    ...
    /**
     * Define device status, SelectorItem should update its UI according on the status.
     */
    public enum Status {
        AVALIABLE,
        CONNECTING,
    ...
    /**
     * Set current device connect status.
     * @param status Current status.
     */
    public void setConnectStatus(Status status) {
        switch(status) {
        case AVALIABLE:
            showConnected(false);
