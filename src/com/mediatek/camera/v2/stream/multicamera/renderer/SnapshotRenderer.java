...
public class SnapshotRenderer extends Renderer {
    private static final Tag TAG = new Tag(
            SnapshotRenderer.class.getSimpleName());
     ...
     */
    public void init() {
        LogHelper.i(TAG, "initScreenSurface");
    ...
    /**
     * draw texture to capture surface.
     */
    @Override
    public void draw() {
        saveRenderState();
        LogHelper.i(TAG, " mCaptureSurface = " + mCaptureSurface);
        if (mCaptureSurface != null) {
            mCaptureEGLSurface = new WindowSurface(mEglCore, mCaptureSurface);
            mCaptureEGLSurface.makeCurrent();
            LogHelper.i(TAG, "Surface width = " + mCaptureEGLSurface.getWidth() + " height = "
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, super.getTextureId());
        // draw
