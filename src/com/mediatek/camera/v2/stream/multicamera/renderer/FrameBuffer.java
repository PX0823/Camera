...
public class FrameBuffer {
    private static final Tag TAG = new Tag(
            FrameBuffer.class.getSimpleName());
    ...
    public void setRendererSize(int width, int height) {
        LogHelper.i(TAG, "initFBO width = " + width + " height = " + height);
        if (width <= 0 || height <= 0) {
            return;
        }
    ...
    private void deleteFBO() {
        ...
        LogHelper.i(TAG, "FrameBuffer glDeleteTextures texture num = 1");
    }
}
