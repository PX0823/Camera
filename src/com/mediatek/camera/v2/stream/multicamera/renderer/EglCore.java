...
/**
 * Core EGL state (display, context, configuration).
 *
 */
public final class EglCore {
    private static final Tag TAG = new Tag(
            EglCore.class.getSimpleName());
    ...
    public EglCore(EGLContext sharedContext, int flags) {
        ...
        mEGLConfig = EGLConfigWrapper.getInstance().getEGLConfigChooser().chooseConfigEGL14(
                mEGLDisplay,
        ...
        if ((flags & FLAG_TRY_GLES3) != 0) {
            ...
            int[] attrib3List = { EGL14.EGL_CONTEXT_CLIENT_VERSION, TEMP_SIZE_NUM3,
                    EGL14.EGL_NONE };
