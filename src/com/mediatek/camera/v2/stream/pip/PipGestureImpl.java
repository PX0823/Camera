...
public class PipGestureImpl implements IPipGesture {
    ...
    public void setPreviewSize(Size previewSize) {
        ...
        LogHelper.i(TAG, "[setPreviewSize]+ : " + previewSize.getWidth() + " x "
    ...
    public void onPreviewAreaChanged(RectF previewArea) {
        LogHelper.i(TAG, "onPreviewAreaChanged previewArea:" + previewArea);
    ...
    private double rotateAngle(float dx, float dy, AnimationRect animationRect) {
        ...
        angle = angle2 - angle1;
        LogHelper.i(TAG, "rotateAngle angle:" + angle);
        return angle;
    }
}