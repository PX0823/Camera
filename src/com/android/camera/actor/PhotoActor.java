...
public class PhotoActor extends CameraActor implements FocusManager.Listener,
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        case KeyEvent.KEYCODE_FINGERPRINT_LONG_PRESS:
            if (mIsInitialized) {
            	 Log.i(TAG, "[onKeyDown] event.getRepeatCount()= " + event.getRepeatCount());
            	 Log.i(TAG, "[onKeyDown] event.getEventTime()= " + event.getEventTime());
                    onShutterButtonFocus(null, true);
                return true;
            }
            return false;
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_FINGERPRINT_LONG_PRESS:
            if (mIsInitialized) {
            	Log.i(TAG, "[onKeyUp] event.getRepeatCount()= " + event.getRepeatCount());
            	 Log.i(TAG, "[onKeyUp] event.getEventTime()= " + event.getEventTime());
                    onShutterButtonClick(null);
                return true;
            }
            return false;
