...
//hezhuohua add begin		
	/*int te = SystemProperties.getInt("ro.camera.dual", 0);		
	android.util.Log.d("hzh_sys","begin te : "+te);		*/
		if(mode == MODE_STEREO_CAMERA){
			Util.setprop(1);
			//SystemProperties.set("persist.sys.dual", "1");
				android.util.Log.d("hzh_sys MODE_STEREO_CAMERA","set "+Util.getprop());		
		}else{
			Util.setprop(0);
			android.util.Log.d("hzh_sys","set "+Util.getprop());
			//SystemProperties.set("persist.sys.dual", "0");
				//android.util.Log.d("hzh_sys","set : 0");		
		}	
		/*te = SystemProperties.getInt("persist.sys.dual", 0);
		android.util.Log.d("hzh_sys","te : "+te);		*/
		//hezhuohua add end
