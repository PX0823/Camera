...
public class RemoteDeviceImpl implements IRemoteDevice {
    private static final Tag TAG = new Tag(
            RemoteDeviceImpl.class.getSimpleName());
    ...
    public <T> T get(Key<T> key) {
        ...
        } else if (KEY_REMOTE_DEVICE_ORIENTATION.getName().equals(key.getName())) {
            return (T) getCameraOrientation(mCameraService);
        } else {
            return null;
        }
    }
    ...
    public void dumpInfo() {
        ...
        int orientation = mCameraService.getCameraOrientation();
        ...
        stringBuilder.append("key = ").append(deviceId).append(" name =")
                ...
                .append(mappingValue).append(" orientation = ")
                .append(orientation);
        LogHelper.i(TAG, "dumpInfo deviceId " + stringBuilder.toString());
    }
    ...
    private Integer getDeviceType(Device device) {
        ...
        LogHelper.i(TAG, "getDeviceType type " + type);
        switch (type) {
        case PHONE:
    ...
    private Integer getCameraOrientation(Service service) {
        return service.getCameraOrientation();
    }
}