...
public class SettingKeys {
    ...
    public static final int SETTING_COUNT = 50;
    // setting key
    ...
    public static final int ROW_SETTING_HDR                       = 6; //common
    public static final int ROW_SETTING_ASD                       = 7; //common
    public static final int ROW_SETTING_DUAL_CAMERA               = 8; //common
    public static final int ROW_SETTING_EXPOSURE                  = 9; //common
    public static final int ROW_SETTING_SCENCE_MODE               = 10; //common
    public static final int ROW_SETTING_WHITE_BALANCE             = 11; //common
    public static final int ROW_SETTING_COLOR_EFFECT              = 12; //common
    public static final int ROW_SETTING_SELF_TIMER                = 13; //camera
    public static final int ROW_SETTING_CONTINUOUS_NUM            = 14;
    public static final int ROW_SETTING_RECORD_LOCATION           = 15; //common
    public static final int ROW_SETTING_VIDEO_QUALITY             = 16; //camera
    public static final int ROW_SETTING_ISO                       = 17; //camera
    public static final int ROW_SETTING_ANTI_FLICKER              = 18; //common
    public static final int ROW_SETTING_VIDEO_STABLE              = 19; //video
    public static final int ROW_SETTING_MICROPHONE                = 20; //video
    public static final int ROW_SETTING_AUDIO_MODE                = 21; //video
    public static final int ROW_SETTING_PICTURE_RATIO             = 22; //video
    public static final int ROW_SETTING_PICTURE_SIZE              = 23; //camera
    public static final int ROW_SETTING_ZSD                       = 24; //camera
    public static final int ROW_SETTING_VOICE                     = 25; //camera
    public static final int ROW_SETTING_3DNR                      = 26;
    public static final int ROW_SETTING_SLOW_MOTION_VIDEO_QUALITY = 27; //video
    public static final int ROW_SETTING_AIS                       = 28; //camera
    public static final int ROW_SETTING_SHARPNESS                 = 29; //common
    public static final int ROW_SETTING_HUE                       = 30; //common
    public static final int ROW_SETTING_SATURATION                = 31; //common
    public static final int ROW_SETTING_BRIGHTNESS                = 32; //common
    public static final int ROW_SETTING_CONTRAST                  = 33; //common
    public static final int ROW_SETTING_IMAGE_PROPERTIES          = 34; //common
    public static final int ROW_SETTING_FLASH                     = 35; //common
    public static final int ROW_SETTING_STEREO_MODE               = 36;
    public static final int ROW_SETTING_FACEBEAUTY_PROPERTIES     = 37; //camera
    public static final int ROW_SETTING_FACEBEAUTY_SMOOTH         = 38; //camera
    public static final int ROW_SETTING_FACEBEAUTY_SKIN_COLOR     = 39; //camera
    public static final int ROW_SETTING_FACEBEAUTY_SHARP          = 40; //camera
    public static final int ROW_SETTING_CAMERA_FACE_DETECT        = 41; //camera
    public static final int ROW_SETTING_MULTI_FACE_MODE           = 42;
    public static final int ROW_SETTING_FACEBEAUTY_SLIM           = 43; //mean's slim effect
    public static final int ROW_SETTING_FACEBEAUTY_BIG_EYES       = 44;
    public static final int ROW_SETTING_FAST_AF                   = 45; //common
    public static final int ROW_SETTING_DISTANCE                  = 46; //common
    public static final int ROW_SETTING_DUAL_CAMERA_MODE          = 47; //common
    public static final int ROW_SETTING_DNG                       = 48; //common
    public static final int ROW_SETTING_SINK_CAMERA               = 49; //common
