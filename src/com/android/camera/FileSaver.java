...
public class FileSaver {
    ...
    private abstract class RequestOperator implements SaveRequest {
        ...
        public void saveImageToDatabase(RequestOperator r) {
            ...
            StereoCameraMode.dcsMimeType = r.mMimeType;
            StereoCameraMode.dcsImageWidth = r.mWidth;
            StereoCameraMode.dcsImageHeight = r.mHeight;
            StereoCameraMode.dcsImageOrientation = r.mOrientation;
            StereoCameraMode.dcsImageName = r.mFileName;
            StereoCameraMode.dcsImagePath = r.mFilePath;
            try {
